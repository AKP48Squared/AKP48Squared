...
function isCommand(delimiters, text, isCmd) {
...
function Context(options) {
  ...
  var rawMessage = options.message || null; // Would be null without explicitly setting it anyway.
  ...
  var isCmd = isCommand(commandDelimiters, text, options.isCommand) || false;
  var args = options.args || parseArgs(text);
  ...
  this.reply = function(msg) {
    global.AKP48.sendMessage(msg, this);
  };
