...
var formatter = function(options) {
  ...
  if (options.showLevel === undefined ? true : options.showLevel) {
    output += options.colorize && options.colorize !== 'message' ? winston.config.colorize(options.level, formatLevel(options.level)) : formatLevel(options.level);
    output += ' | ';
  }
  output += options.colorize === 'all' || options.colorize === 'message' ? winston.config.colorize(options.level, options.message) : options.message;
